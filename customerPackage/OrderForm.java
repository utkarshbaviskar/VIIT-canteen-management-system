...
//            }
    ...
    private void btn_stillOrderingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_stillOrderingActionPerformed
        ...
        boolean success = new myOrderFunctions().placeOrder(customer.getId(), customer.getName(), customer.getMobilePhone(), cbx_choose_order.getSelectedItem().toString(), (Integer) spin_quantity.getValue());

        if (success) {
            JOptionPane.showMessageDialog(this, "Item added Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Pls Try again", "Error", JOptionPane.ERROR_MESSAGE);
