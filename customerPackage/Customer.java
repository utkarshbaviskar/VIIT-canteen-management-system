...
public class Customer extends User
{
    ...
    public void cancelOrder()
    {
        ...
        if (tempOrder.getCanelTimeInMillis()>=currentTime && !BillForm.served)
        {
        ...
        for (String a : order)
        {
            ...
            try
            {
                ...
                if (rs.next())
                {
                    ...
                    String oboy = rs.getString("order_Waiter");
