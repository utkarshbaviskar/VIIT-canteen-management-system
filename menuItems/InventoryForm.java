...
public class InventoryForm extends javax.swing.JFrame
{
    ...
    private void btn_addItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addItemActionPerformed
        ...
        if ((txt_itemName.getText().isEmpty()) || (txt_itemPrice.getText().isEmpty()) || (cbx_viewitem.getSelectedItem().toString().isEmpty()) || (txt_itemQuantity.getText().isEmpty()))
        {
        ...
        manager.addInventoryItem(txt_itemName.getText(), Integer.valueOf(txt_itemPrice.getText()), cbx_viewitem.getSelectedItem().toString(), Integer.valueOf(txt_itemQuantity.getText()));
