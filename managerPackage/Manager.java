...
public class Manager extends User
{
    ...
    void addWaiter(Waiter waiter)
    {
        try
        {
            ...
            String Query = "INSERT INTO menu_items.waiters (id_waiters ,name_waiters ,start_time_waiters,finish_time_waiters ,status_waiters ,orderList_waiters)"
                    + " VALUES (?,?,?,?,?,?,?)";
...
//                    MainMenu.categoryList.get(CategoryName).add(menuitem);
            ...
            try
            {
                ...
                query = "INSERT INTO inventory ( item_id , available_quantity, units_sold  , number_rate)" + " VALUES(?,?,?,?)";
                PreparedStatement preparedStmt = MyConnection.getConnection().prepareStatement(query);
                preparedStmt.setInt(1, itemID);
                preparedStmt.setInt(3, 0);
