    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(lbLogo1, javax.swing.GroupLayout.PREFERRED_SIZE, 352, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(74, 74, 74))
        );
        ...
        try
        {
            ...
            if (!username.isEmpty() && !password.isEmpty() && !mobilePhone.isEmpty() && !name.isEmpty())
            {
                try
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(this, "Invalid Mobile Phone, Mobile Phone must consist of 10 numbers", "Invalid Input", JOptionPane.ERROR_MESSAGE);
                        txtPhoneSignup.setText("");
                    }
                    ...
                    else
                    {
                        if ("Manager".equals(type))
                        {
                            ...
                            else
                            {
                                ...
                                Kitchen c = new Kitchen(id, name, username, mobilePhone, password, address);
